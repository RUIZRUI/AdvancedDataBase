...
*/
$bd = 'localhost/CNDB';
$connection = OCI_connect('ora00103', 'dfazAF', $bd);
if(!$connection) 
        {
...
$curs1 = OCI_parse($connection, "select p.part_id as aa, p.part_name as bb from component c, part p where c.component_id=p.part_id and c.part_id='$num'");
...
*/
OCI_Define_By_Name($curs1,"AA",$part_id);
OCI_Define_By_Name($curs1,"BB",$part_name);
